RSpec.describe FujiMarkdown::Preprocessors::Ruby do
  ...
  context 'with "{漢字|かんじ}"' do
    ...
    it 'converts the text into "<ruby>漢字<rt>かんじ</rt></ruby>"' do
      subject
  ...
  context 'with "{漢字|かん|じ}"' do
    ...
    it 'converts the text into "<ruby>漢<rt>かん</rt>字<rt>じ</rt></ruby>"' do
      subject
  ...
  context 'with "{振仮名余|ふり|が|な|あま|り}"' do
    ...
    it 'converts the text into "<ruby>振<rt>ふり</rt>仮<rt>が</rt>名<rt>な</rt>余<rt>あま</rt><rt>り</rt></ruby>"' do
      subject
  ...
  context 'with "{漢字余|かん|じあまり}"' do
    ...
    it 'converts the text into "<ruby>漢<rt>かん</rt>字余<rt>じあまり</rt></ruby>"' do
      subject
  ...
  context 'with "\{漢字|かんじ}"' do
    ...
    it 'does not convert the text' do
      subject
